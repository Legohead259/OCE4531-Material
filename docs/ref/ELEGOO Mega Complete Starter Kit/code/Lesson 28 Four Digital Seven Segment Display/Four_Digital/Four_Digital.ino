...
const int digit0   = 22;   // 7-Segment pin D4
const int digit1   = 23;   // 7-Segment pin D3
const int digit2   = 24;   // 7-Segment pin D2
const int digit3   = 25;   // 7-Segment pin D1 
...
void HexCounter(){
    ...
    if ((displayDigits[0] == 0)&&(displayDigits[1] == 0)&&(displayDigits[2] == 0)&&(displayDigits[3]==0)){
