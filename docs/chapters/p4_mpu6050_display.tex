...
\emph{If it is not clear where your challenge-specific code is, it may not be counted.}
    ...
    \subsection*{Challenge 2: Eliminating Gravity}
    ...
    \marginnote{\textbf{Note:} For this challenge, you will need to create a rotation matrix or use quaternions to translate the values from the body reference frame to the global (North-East-Down) frame.}
