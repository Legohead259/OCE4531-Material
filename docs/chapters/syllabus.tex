...
\section*{Course Policies} \labsec{course_policies}
    ...
    Appeals for special consideration must be made \textbf{with one hour} of the specified deadline passing. 
    Appeal requests made after this window will not be considered. Period.
    If an appeal is granted, no penalty points will be applied and the deal reached by the instructor and student will preempt the assignment requirements. 
